...
const SecondStep = ({ sendData }) => {
  ...
  const { handleSubmit, handleChange, values, touched, errors } = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      surname: Yup.string().min(3, "Minimum 3 characters").required("Required"),
      phone: Yup.number()
        ...
        <Form onSubmit={handleSubmit}>
          <Grid container justifyContent="center" alignItems="center">
            <Grid item xs={12} sm={6}>
              <Box
                sx={{ display: "flex", alignItems: "flex-end", mb: 2, mr: 1 }}
              >
                <AccountCircle
          ...
          <TextField
            ...
            multiline
            rows={5}
            placeholder="A litle bit about yourself. Why do you want to learn?"
            variant="outlined"
            sx={{ mb: 2, width: "100%" }}
          />
